...
jpackage --name minesweeper --description "Minesweeper for Linux with compiler and jar tool included" --input ../../app --dest ../../ --main-jar minesweeper.jar --icon ../src/MySweep/Icons/MineSweeperIcon.png --runtime-image ../../jre --app-version 2.0 --install-dir $InstallDir
[ -f "../../minesweeper.cfg" ] && mv ../../minesweeper.cfg ../
