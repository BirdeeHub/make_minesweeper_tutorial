...
..\..\runtime\javac.exe ..\src\MySweep\*.java ..\src\*.java -d ..\minesweeper_jar_in && cd ..\minesweeper_jar_in && ..\..\runtime\jar.exe -cvfe ..\minesweeper.jar MySweep.MineSweeper . ..\src ..\Compiling ..\Packaging ..\README.md && cd ..
