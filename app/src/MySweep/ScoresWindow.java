...
public class ScoresWindow extends JFrame {
    ...
    private void BoardButtonDeleteAction(JButton BoardPressed){
        MineSweeper.getIOmanager().deleteScoreEntry(((ScoreEntry)BoardPressed.getClientProperty("BoardTarget")));//<-- delete score from file
    ...
    private void leaderboardText(JPanel BoardPanel, JPanel LivesPanel, JPanel TimePanel, ActionListener BoardButtonListener, KeyAdapter keyAdapter){
        ...
        String Shtml="<html>";
        String Ehtml="</html>";
        ScoreEntry[] entries = MineSweeper.getIOmanager().readLeaderboard();//<-- read scores file to ScoreEntry array
